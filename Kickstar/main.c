...
/**
 * @brief Cleanup and ensure all programs exit with the same message even if it fails
 */
void cleanup() {
...
int main(int argc, char *argv[]) {
    char *filepath = NULL;
    /* Gracefully handle abnormal termination */
    atexit(cleanup);
    ...
    printf("\nAmount of discarded wagons : %u\n", discarded_wagons (array, trainSize));
